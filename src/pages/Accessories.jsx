    ...
    return (
        <Container>
            ...
            <Row className="mt-5 mb-5">
                <Col>
                    <Card border="info">
                        <Card.Img variant="top" src="/images/cooler.jpg" />
                        <Card.Header><Card.Title>Coolers</Card.Title></Card.Header>
                        <Card.Body>
                            <Card.Text>
                ...
                <Col>
                    <Card border="info">
                        <Card.Img variant="top" src="/images/opener1.jpg" />
                        <Card.Header><Card.Title>Openers</Card.Title></Card.Header>
                        <Card.Body>
                            <Card.Text>
                                Some quick example text to build on the card title and make up the
                                bulk of the card's content.
